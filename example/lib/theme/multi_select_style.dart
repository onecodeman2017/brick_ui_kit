...
FMultiSelectFieldStyle _multiSelectFieldStyle({
  required FColors colors,
  required FTypography typography,
  required FStyle style,
}) {
...
FMultiSelectTagStyle _multiSelectTagStyle({
  required FColors colors,
  required FTypography typography,
  required FStyle style,
...
FCircularProgressStyle _circularProgressStyle({required FColors colors}) =>
