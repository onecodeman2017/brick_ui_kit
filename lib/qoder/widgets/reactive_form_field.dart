...
class QReactiveFormField extends StatelessWidget {
  ...
  /// 构建文本输入框
  ///
  /// 优先使用 forUI 的 FTextFormField 组件。
  ...
  /// 构建文本区域
  ///
  /// 优先使用 forUI 的 FTextFormField.multiline 组件。
  ...
  /// 构建单选按钮组
  ///
  /// 优先使用 forUI 的 FSelectGroup 组件（单选模式）。
  ...
  /// 构建复选框
  ///
  /// 优先使用 forUI 的 FSelectGroup 组件（复选模式）。
